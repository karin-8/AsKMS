...
- July 3, 2025. Fixed Agent Chatbot document selection issue - resolved problem where selected documents in Create Agent Chatbot weren't being saved to agent_chatbot_documents table, updated PUT route for agent updates to properly handle documentIds parameter, and implemented proper document association synchronization for both create and update operations
```

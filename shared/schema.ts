...
export const achievements = pgTable("achievements", {
  ...
  type: varchar("type", { length: 50 }).notNull(), // 'document_read', 'search', 'chat', 'feedback', 'favorite'
  category: varchar("category", { length: 50 }).notNull(), // 'beginner', 'intermediate', 'advanced', 'special'
  icon: varchar("icon", { length: 100 }).notNull(), // lucide icon name
  color: varchar("color", { length: 20 }).notNull(), // color theme
...
export const userStats = pgTable("user_stats", {
  ...
  feedbackProvided: integer("feedback_provided").notNull().default(0),
